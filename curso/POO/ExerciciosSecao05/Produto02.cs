...
namespace curso.POO.ExerciciosSecao05
{
    public class Produto02
    {
        ...
        {           
            ...
            Produto02 produto = new Produto02(nome, preco, quantidade);
        ...
        public static void ExibirDadosProduto(Produto02 produto)
        {
            Console.Clear();
            Console.WriteLine("\n=============================================");
        ...
        public static void AdicionarOuRemoverProduto(Produto02 produto)
        {
        ...
        public static void AdicionarQuantidadeProduto(Produto02 produto)
        {
        ...
        public static void RemoverProdutos(Produto02 produto)
        {
